      ...
      <form>
        <div class="container">
          ...
          <div class="help-box" x-cloak x-show="helpBoxOpen">
            <div class="section">
              <p>
                This Smart cell sends a message to a Telegram channel. In order to use it, you need to
                <a href="https://api.slack.com/tutorials/tracks/getting-a-token" target="_blank">create a Telegram bot and get your bots's token</a>.
              </p>
            </div>
          </div>
          <div class="row">
